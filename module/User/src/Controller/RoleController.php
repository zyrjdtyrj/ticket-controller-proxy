<?php
  ...
  class RoleController extends AbstractActionController
  {
    ...
    public function addAction()
    {
      ...
      $form->get('parent')->setValueOptions($roleList);
      ...
      if ($this->getRequest()->isPost()) {
        ...
        if ($form->isValid()) {
          ...
          // Add a flash message.
          $this->flashMessenger()->addSuccessMessage('Новая роль создана.');
    ...
    public function editAction()
    {
      ...
      if ($this->getRequest()->isPost()) {
        ...
        if ($form->isValid()) {
          ...
          // Add a flash message.
          $this->flashMessenger()->addSuccessMessage('Роль изменена.');
        ...
        $form->setData(array(
          ...
          'parent'      => $role->getParentRoles()->first()
        ));
      }
    ...
    public function editPermissionsAction()
    {
      ...
      if ($this->getRequest()->isPost()) {
        ...
        if ($form->isValid()) {
          ...
          // Add a flash message.
          $this->flashMessenger()->addSuccessMessage('Разрешения обновлены.');
    ...
    public function deleteAction()
    {
      ...
      // Add a flash message.
      $this->flashMessenger()->addSuccessMessage('Роль удалена.');
