...
class PermissionController extends AbstractActionController
{
  ...
  public function addAction()
  {
    ...
    if ($this->getRequest()->isPost()) {
      ...
      if ($form->isValid()) {
        ...
        // Add a flash message.
        $this->flashMessenger()->addSuccessMessage('Добавлено новое разрешение');
  ...
  public function editAction()
  {
    ...
    if ($this->getRequest()->isPost()) {
      ...
      if ($form->isValid()) {
        ...
        // Add a flash message.
        $this->flashMessenger()->addSuccessMessage('Разрешение обновлено');
  ...
  public function deleteAction()
  {
    ...
    // Add a flash message.
    $this->flashMessenger()->addSuccessMessage('Разрешение удалено');
